  ...
  return (
    <div className="absolute top-[5px] left-[5px] min-w-[300px] h-[100px] z-40 flex flex-col gap-[4px]">
      <div className="flex gap-[12px]">
        <div className="group/title flex items-center hover:outline hover:outline-1 hover:outline-blueApp hover:rounded-[4px]">
        ...
        <div className="flex items-center gap-0 rounded-[40%] overflow-hidden">
      ...
      <div
        className={clsx(
          "px-[4px] transition-all delay-500",
